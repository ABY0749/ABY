  ...
  return (
    <div style={{ 
      ...
      <div className="glass-panel animate-fade-in" style={{ width: '100%', maxWidth: '450px', padding: '2.5rem', position: 'relative', textAlign: 'center' }}>
        <div style={{ width: '70px', height: '70px', background: 'linear-gradient(135deg, var(--primary), #a855f7)', borderRadius: '18px', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 1.5rem', color: 'white', fontSize: '2.5rem', fontWeight: 'bold', boxShadow: '0 0 30px var(--primary-glow)', fontFamily: "'Playfair Display', serif" }}>A</div>
        <h1 style={{ fontSize: '2.5rem', color: 'white', marginBottom: '0.5rem', fontWeight: '900', fontFamily: "'Playfair Display', serif", letterSpacing: '-1px' }}>{isRegistering ? 'CREATE ACCOUNT' : 'ABY ELITE SUITES'}</h1>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
          ...
          <button type="submit" className="btn-primary animate-pulse-glow" style={{ padding: '1.2rem', marginTop: '1.5rem', fontSize: '1.1rem', fontWeight: '900', letterSpacing: '1px' }}>
