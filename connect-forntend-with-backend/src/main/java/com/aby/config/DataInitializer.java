    ...
    public void run(String... args) throws Exception {
        if (hotelRepository.count() == 0) {
            Hotel h1 = new Hotel(null, "CROWN suites",
                    ...
                    "₹2/night", 4.9, "0.5 miles");
            Hotel h2 = new Hotel(null, "HOME STAY", "https://images.unsplash.com/photo-1518780664697-55e3ad937233?w=600&auto=format&fit=crop&q=60", "₹2/night", 5.0, "1.2 miles");
